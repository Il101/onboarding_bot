...
def test_long_text_multiple_chunks():
    text = ("Sentence one. " * 500).strip()
    chunks = chunk_text(text)
    assert len(chunks) >= 2


def test_overlap_between_chunks():
    text = ("First sentence. Second. Third. Fourth. Fifth. Sixth. Seventh. Eighth. Ninth. Tenth. ") * 15
...
def test_telegram_chunker_groups_and_chunks():
    messages = [
        _msg(1, "2024-01-15T10:00:00", "A", "Hello"),
        _msg(2, "2024-01-15T10:10:00", "B", "Reply"),
        _msg(3, "2024-01-15T11:00:00", "A", "New topic"),
    ]
...
def test_metadata_present():
    messages = [_msg(1, "2024-01-15T10:00:00", "A", "Text")]
    chunks = chunk_telegram_messages(messages, window_minutes=30)
